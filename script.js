...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (orderForm && successModal) {
        orderForm.addEventListener('submit', async (e) => {
            ...
            try {
                // Supabase REST API 호출 (데이터베이스 저장)
                const supabaseUrl = 'https://cshfdxfbzpvxhxotrjjp.supabase.co';
                const supabaseAnonKey = 'sb_publishable_ovHIrP3x-l6aht8wvSediA_ukoR0lKP';
                ...
                // Supabase Edge Function 호출 (이메일 알림 전송)
                try {
                    ...
                    console.error('이메일 알림 전송 실패:', emailErr);
                }
